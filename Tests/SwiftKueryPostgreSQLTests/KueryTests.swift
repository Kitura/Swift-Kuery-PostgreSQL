...
#if os(Linux)
let tableName = "myTableLinux"
#else
let tableName = "myTableOSX"
#endif
...
class KueryTests: XCTestCase {
    ...
    func testExample() {
        ...
        connection.connect() { error in
            ...
            connection.execute("DROP TABLE " + tableName) { result in
                
                print("=======CREATE TABLE \(tableName) (a varchar(40), b integer)=======")
                                                                            ...
                                                                            connection.execute(query: s7) { result in
                                                                                ...
                                                                                connection.execute(query: s8) { result in
                                                                                    ...
                                                                                    connection.execute(query: s9) { result in
                                                                                        ...
                                                                                        let s10 = "Select * from \(tableName) where a IN ('apple', 'lalala')"
                                                                                        print("=======\(s10)=======")
